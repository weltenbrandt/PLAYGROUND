...
function scr_player_init()
{
	...
	#macro id_player_data_attack2_duration 67
	#macro id_player_data_attack2_combothreshold_min 68
	#macro id_player_data_attack2_combothreshold_max 69
	
	#macro id_player_data_snds_step 70
	#macro id_player_data_snds_attack1 71
	#macro id_player_data_snds_attack2 72
	#macro id_player_data_snds_roll 73
	#macro id_player_data_snds_runstop 74
	
	#macro id_player_data_runstop_timer 75
	...
	player[id_player_data_snds_step] = [snd_step_1,snd_step_2];
	player[id_player_data_snds_attack1] = [snd_attack_1];
	player[id_player_data_snds_attack2] = [snd_attack_2];
	player[id_player_data_snds_roll] = [snd_roll];
	player[id_player_data_snds_runstop] = [snd_step_1,snd_step_2];
